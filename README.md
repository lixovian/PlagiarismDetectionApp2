...
Простите, что код не в src - в райдере по умолчанию проекты очень не любят физические папки, которые делают так, что проекты лежат не в одной директории с солюшном. Реализованы все нужные функции, в том числе связь с облаком слов.
